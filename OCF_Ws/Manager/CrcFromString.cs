...
{
	public class CrcFromString : HashAlgorithm
	{
		public static string CRC32OfString(string s)
		{
			...
			CrcFromString crc32 = new CrcFromString();
			original = Encoding.UTF8.GetBytes(s);
		...
		public CrcFromString(UInt32 polynomial, UInt32 seed)
		{
