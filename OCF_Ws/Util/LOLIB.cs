...
namespace OCF_Ws.Util
{
    ...
    public class LOLIB : IDisposable
    {
		...
		public string FormatID(string GuidID)
		{
			Guid oCardId;
        ...
        {
            FileUtil.RemoveFile(LOG_PATH + Code + ".log");
        }
        public void RenameFileLog(string oldName, string newName)
        {
            FileUtil.RenameFile(LOG_PATH + oldName + ".log", LOG_PATH + newName + ".log");
        }
        /// <summary>
        /// Restituiscelo StackFrame da dove parte la chiamata al log.
        /// </summary>
        ...
        {
            FileUtil.WriteLineAppend(LOG_PATH, Code + ".log", logMessage);
        }
        ...
        private void Write(string Code, int lv, string message)
        {
            ...
            {
                case LEVEL_QUEUE:
                case LEVEL_ERROR: Priority = " ERROR :      ";

                    break;
                case LEVEL_DEBUG: Priority = " WARNING :    ";

                    break;
                case LEVEL_INFO: Priority = " INFORMATION: ";
