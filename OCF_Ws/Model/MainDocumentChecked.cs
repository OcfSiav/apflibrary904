...
{
	[DataContract]
	public class MainDocumentChecked
	{
		[DataMember(Name = "Filename", IsRequired = true)]
		public string Filename { get; set; }
		[DataMember(Name = "BinaryContent",IsRequired = true)]
		public string BinaryContent { get; set; }
		[DataMember(Name = "OutcomeCheck", IsRequired = true)]
		public string OutcomeCheck { get; set; }
		...
		public string ToXml()
		{
			...
			sToXML += "	" + "<OutcomeCheck>" + (string.IsNullOrEmpty(this.OutcomeCheck) ? "" : this.OutcomeCheck) + "</OutcomeCheck>" + System.Environment.NewLine;
			sToXML += "</MainDoc>";
			return sToXML;
		}
